...
import java.sql.Date;  //Sirve para usar el Date.valueOf()
...
@Controller
@CommonsLog   //Para imprimir còdigo en consola
public class EmpleadoConsultaController {
	...
	@ResponseBody
	public List<Empleado> consulta(int estado, int idPais, String nomApe, String fecDesde, String fecHasta)
	{
		List<Empleado> lstSalida = service.listaConsultaEmpleado(estado, 
														idPais, 
														"%" + nomApe + "%",
														Date.valueOf(fecDesde),
														Date.valueOf(fecHasta)); //CONVIERTE cadena String en una FECHA EN FORMA DE yy//mm/dd
		return lstSalida;
	}
	
	/*Mètodo para generar el REPORTE*/
